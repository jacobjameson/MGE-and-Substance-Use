...
# PURPOSE:            Generate main table results (imputation)
#-------------------------------------------------------------------------
#
# Create dataset ----------------------------------------------------------

source('src/imputation analysis/Construct Analytical Dataset Imputation.R')
...
gt::gtsave(as_gt(t1.unweighted), "outputs/imputation/tables/Table 1 Unweighted.pdf")
...
gt::gtsave(as_gt(t1.weighted), "outputs/imputation/tables/Table 1 Weighted.pdf")
...
sink("outputs/imputation/tables/Table 2.txt")
...
# Start the sink to capture output
sink("outputs/imputation/tables/Appendix 5.txt")
...
# Start the sink to capture output
sink("outputs/imputation/tables/Appendix 6.txt")
...
# Start the sink to capture output
sink("outputs/imputation/tables/Appendix 7.txt")
...
# Start the sink to capture output
sink("outputs/imputation/tables/Appendix 8.txt")
