...
# PURPOSE:            Generate figures (imputation)
#-------------------------------------------------------------------------
...
ggsave("outputs/imputation/figures/Figure 1.png", width = 15, height = 10, bg = 'white')
...
ggsave("outputs/imputation/figures/Figure 2.png", width = 15, height = 9, bg = 'white')
...
ggsave("outputs/imputation/figures/Figure 3.png", width = 14, height = 10, bg = 'white')
...
ggsave("outputs/imputation/figures/Appendix 9.png", width = 16, height = 10, bg = 'white')
